...
locals {
  organization_name = "lhbrnah"
  account_name      = "ei45611"
  private_key_path  = "C:\\Users\\kamal\\Github\\sfguide-terraform-sample\\snowflake_tf_snow_key.p8"
}
